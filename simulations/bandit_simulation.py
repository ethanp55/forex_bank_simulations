...
with open(f'../results/data/bandit_training_profits_0_{int(bank_balance_multiplier * 10)}.pickle', 'wb') as f:
    pickle.dump(training_profits, f)

with open(f'../results/data/bandit_test_profits_0_{int(bank_balance_multiplier * 10)}.pickle', 'wb') as f:
