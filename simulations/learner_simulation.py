...
dqn_agents = [DQNAgent(f'DQN_{i}', state_dim) for i in range(n_last_agent_type)]
...
plt.savefig(f'../results/learner_training_profits_0_{int(bank_balance_multiplier * 10)}', bbox_inches='tight')
plt.clf()
